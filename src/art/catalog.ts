...
export const STYLE_BRIEF =
  'การ์ตูนผีเล่มละบาทยุค 80–90 เส้นหมึกดำหนาหยาบ สีหม่น 4–5 สี เงาเป็นปื้น พิมพ์เหลื่อมนิดหน่อย เสื้อผ้าชาวบ้านเรียบ รูปทรงอ่านง่าย ไม่ใช้แสงภาพยนตร์หรือแฟนตาซีอลังการ';
