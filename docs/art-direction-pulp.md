...
เพิ่ม `assets/monsters/phi-pop.png` และ `assets/classes/{shaman,warrior,nun,medium}.png` แล้วผูกไว้ใน `ART_SOURCES`. ภาพสร้างด้วย built-in imagegen; ตรวจ alpha และย่อเป็นขนาดตาม catalog ก่อนนำเข้า
